...
/** 
 * The class {@code PongView} does nothing but visualizing the Model: it uses the getters of the Model to get all the necessary
 *information – where the two bars are, where the ball is, and so on, and shows this information to the
 *user.
*/
